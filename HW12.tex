...
\end{kframe}
\end{knitrout}
We make an error of Type I for a left-tailed test 0.035 = 3.5\% for Beta(10,2),  0.066 = 6.6\% for Beta(2,10), and 0.058 = 5.8\% for Beta(10,10).
    \item What proportion of the time do we make an error of Type I for a
    right-tailed test?
\begin{knitrout}\scriptsize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
...
\end{kframe}
\end{knitrout}
We make an error of Type I for a right-tailed test 0.08 = 8\% for Beta(10,2),  0.034 = 3.4\% for Beta(2,10), and 0.044 = 4.4\% for Beta(10,10).
    \item What proportion of the time do we make an error of Type I for a
    two-tailed test?
\begin{knitrout}\scriptsize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
