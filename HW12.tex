...
\end{kframe}
\end{knitrout}
The Type I error rate for a Laplace distribution with $a=0$ and $b=4.0$ by using a simulation is 0.075 = 7.5\%. 
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Question 2
...
\end{kframe}
\end{knitrout}
We make an error of Type I for a left-tailed test 0.03 = 3\% for Beta(10,2),  0.077 = 7.7\% for Beta(2,10), and 0.056 = 5.6\% for Beta(10,10).
    \item What proportion of the time do we make an error of Type I for a
    right-tailed test?
\begin{knitrout}\scriptsize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
...
\end{kframe}
\end{knitrout}
We make an error of Type I for a right-tailed test 0.072 = 7.2\% for Beta(10,2),  0.024 = 2.4\% for Beta(2,10), and 0.052 = 5.2\% for Beta(10,10).
    \item What proportion of the time do we make an error of Type I for a
    two-tailed test?
\begin{knitrout}\scriptsize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
